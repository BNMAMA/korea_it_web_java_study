...
public class String01 {
    public static void main(String[] args) {
        String str = "My name is SoHyun Kim";
        ...
        System.out.println(str.contains("name")); //포함여부 , 결과
        ...
        System.out.println();
        System.out.println(str.startsWith("I like")); //해당 문자열로 시작해? => boolean
        System.out.println(str.startsWith("My name"));
        System.out.println();
        System.out.println(str.endsWith("travel")); //해당 문자열로 끝나? => boolean
