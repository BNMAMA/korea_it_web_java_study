...
//        실행이 되기 전에 1감소
        ...
        System.out.println();
        //비교 연산자 => 결과가 항상 boolean 참/거짓 둘 중 하나로만
        num1 = 5;
        num2 = 3;
        System.out.println(num1 > num2);
        System.out.println(num1 >= num2);
        ...
        // || => 선조건이 true이면 후조건을 실행하지 않는다, 선조건이 false일 때만 후조건을 실행한다.
        ...
        /*
        * int height = 숫자;
        * 키가 120이상인 경우 탑승 가능하도록 하는 삼항 연산사
        * 가능하면 "탑승가능" 불가능하면 "탑승 불가능"
        */

        int height = 160;
        String cm = (height >= 120) ? "탑승 가능" : "탑승 불가능";
